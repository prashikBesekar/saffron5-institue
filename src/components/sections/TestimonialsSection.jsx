      ...
      <div className="max-w-7xl mx-auto px-5">
          ...
          {testimonials.map((t) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-5xl text-gray-100 font-serif leading-none select-none">
                  "
                </span>
              </div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                <div
                  className={`w-10 h-10 ${t.avatarBg} rounded-xl flex items-center justify-center text-white text-xs font-bold flex-shrink-0`}
                >
                  {t.initials}
                </div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 text-center">
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {[
                ...
                <div
                  key={i}
                  className={`w-7 h-7 ${c} rounded-full border-2 border-white flex items-center justify-center`}
                >
            ...
            <p className="text-sm text-gray-600 font-medium">
              Join <span className="text-green-700 font-bold">10,000+</span>{" "}
              students
            </p>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-sm text-gray-600 font-medium">
              <span className="text-gray-900 font-bold">4.9/5</span> average
              rating
            </p>
          </div>
          <div className="hidden sm:block w-px h-5 bg-gray-200" />
          <p className="text-sm text-gray-500">
            Across{" "}
            <span className="text-gray-700 font-semibold">28 states</span> in
            India
          </p>
        </div>
      </div>
